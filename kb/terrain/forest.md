---
id: terrain/forest
title: "Classic Oak Woodland (forest biome)"
kind: terrain
wiki: https://minecraft.wiki/w/Forest
game_version: "1.19.3 (Java)"
fetched_at: 2026-09-05
updated_at: 2026-09-05
status: absent
tags: [biome, terrain, forest]
related_docs: [docs/ALL_BIOMES_ELEVATION_PLAN.md]
---

# Classic Oak Woodland
...
from https://minecraft.wiki/w/Forest before implementing.

## Registry facts (source of truth: `catalog/biome-registry.json`)

| registry id | `oak_forest` |
| vanilla | forest |
| tree | oak |
| density | 0.012 |
| map color | rgb(64, 145, 108) |
| notes | Density doubles (0.016/0.008) by forest noise |
...
| Concern | Where |
|---|---|
| Registry | `catalog/biome-registry.json` id `oak_forest` (implemented, `kb` was null) |
| Selection | `src/game/terrain/biomes.ts` |
| Surface/scatter | `src/game/terrain/terrainGenerator.ts` |
| Visualizer | `seed-page/main.ts` (`/seed.html` links `/kb/terrain/forest`) |
...
- Set the biome's `kb:` field to `terrain/forest.md` once this entry is real.
