---
id: terrain/old-growth-pine-taiga
title: "Giant Redwood Taiga (old_growth_pine_taiga biome)"
kind: terrain
wiki: https://minecraft.wiki/w/Old_Growth_Pine_Taiga
game_version: "1.19.3 (Java)"
fetched_at: 2026-09-05
updated_at: 2026-09-05
status: absent
tags: [biome, terrain, old-growth-pine-taiga]
...
from https://minecraft.wiki/w/Old_Growth_Pine_Taiga before implementing.
...
| Concern | Where |
|---|---|
| Registry | `catalog/biome-registry.json` id `redwood` (implemented, `kb` was null) |
| Selection | `src/game/terrain/biomes.ts` |
| Surface/scatter | `src/game/terrain/terrainGenerator.ts` |
| Visualizer | `seed-page/main.ts` (`/seed.html` links `/kb/terrain/old-growth-pine-taiga`) |
...
- Set the biome's `kb:` field to `terrain/old-growth-pine-taiga.md` once this entry is real.
