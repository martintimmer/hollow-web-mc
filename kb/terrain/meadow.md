---
id: terrain/meadow
title: "Flowering Blossom Meadow (meadow biome)"
kind: terrain
wiki: https://minecraft.wiki/w/Meadow
game_version: "1.19.3 (Java)"
fetched_at: 2026-09-05
updated_at: 2026-09-05
status: absent
tags: [biome, terrain, meadow]
related_docs: [docs/ALL_BIOMES_ELEVATION_PLAN.md]
---

# Flowering Blossom Meadow
...
from https://minecraft.wiki/w/Meadow before implementing.
...
| tree | meadow |
| density | 0.005 |
| map color | rgb(255, 140, 180) |
| notes | Elevation band SEA+5..SEA+24 |
...
| Concern | Where |
|---|---|
| Registry | `catalog/biome-registry.json` id `meadow` (implemented, `kb` was null) |
| Selection | `src/game/terrain/biomes.ts` |
| Surface/scatter | `src/game/terrain/terrainGenerator.ts` |
| Visualizer | `seed-page/main.ts` (`/seed.html` links `/kb/terrain/meadow`) |
...
- Set the biome's `kb:` field to `terrain/meadow.md` once this entry is real.
