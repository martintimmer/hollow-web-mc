---
id: terrain/cherry-grove
title: "Cherry Blossom Grove (cherry_grove biome)"
kind: terrain
wiki: https://minecraft.wiki/w/Cherry_Grove
game_version: "1.19.3 (Java)"
fetched_at: 2026-09-05
updated_at: 2026-09-05
status: absent
tags: [biome, terrain, cherry-grove]
...
from https://minecraft.wiki/w/Cherry_Grove before implementing.
...
| tree | cherry |
| density | 0.014 |
| map color | rgb(255, 183, 213) |
| notes | Highland humidity band |
...
| Concern | Where |
|---|---|
| Registry | `catalog/biome-registry.json` id `cherry` (implemented, `kb` was null) |
| Selection | `src/game/terrain/biomes.ts` |
| Surface/scatter | `src/game/terrain/terrainGenerator.ts` |
| Visualizer | `seed-page/main.ts` (`/seed.html` links `/kb/terrain/cherry-grove`) |
...
- Set the biome's `kb:` field to `terrain/cherry-grove.md` once this entry is real.
