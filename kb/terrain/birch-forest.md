---
id: terrain/birch-forest
title: "White Birch Woods (birch_forest biome)"
kind: terrain
wiki: https://minecraft.wiki/w/Birch_Forest
game_version: "1.19.3 (Java)"
fetched_at: 2026-09-05
updated_at: 2026-09-05
status: absent
tags: [biome, terrain, birch-forest]
...
from https://minecraft.wiki/w/Birch_Forest before implementing.
...
| Concern | Where |
|---|---|
| Registry | `catalog/biome-registry.json` id `birch` (implemented, `kb` was null) |
| Selection | `src/game/terrain/biomes.ts` |
| Surface/scatter | `src/game/terrain/terrainGenerator.ts` |
| Visualizer | `seed-page/main.ts` (`/seed.html` links `/kb/terrain/birch-forest`) |
...
- Set the biome's `kb:` field to `terrain/birch-forest.md` once this entry is real.
