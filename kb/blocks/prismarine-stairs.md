---
id: blocks/prismarine-stairs
title: "Prismarine stairs"
kind: block
wiki: https://minecraft.wiki/w/Prismarine_stairs
...
STUB — auto-created by `scripts/kbExpand.mjs` on 2026-09-05. Fill in from https://minecraft.wiki/w/Prismarine_stairs before implementing.
...
| id | name | category |
|---|---|---|
| 75 | Prismarine stairs | nether_end |
